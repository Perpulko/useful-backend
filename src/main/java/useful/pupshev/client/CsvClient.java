...
public class CsvClient {
  ...
  public static final String URLCLASSIFICATORSXLS = "https://classifikators.ru/assets/downloads/oktmo/oktmo.xlsx";
  public Path targetPath = Path.of("data1.csv");
  public Path targetPath2 = Path.of("dataXlsx.xlsx");
